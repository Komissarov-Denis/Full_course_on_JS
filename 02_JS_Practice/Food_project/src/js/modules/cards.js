...
export default function cards() {    
	class MenuCards {
		...
		render() { // классическое название для формирование верстки - метод render()
			...
			} else { // если в массив this.classes хоть один класс передан, то каждому добавляем класс => назовем каждый элемент внутри массива classes как className, так как стрелочная функция будет принимать этот аргумент className
