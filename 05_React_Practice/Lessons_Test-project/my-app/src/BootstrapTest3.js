...
// REF существуют и сохраняются при любом перерендеринге компонента и при этом изменение REF не вызывает ререндер компонента, т.е. мы можем сохранять определенные данные в течение 
// жизни всего компонента
