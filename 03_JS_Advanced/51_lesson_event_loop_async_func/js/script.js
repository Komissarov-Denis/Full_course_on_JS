...
setTimeout(() => { // далее - асинхронную функцию с задержкой в 2000 миллисекунд
	console.log('timeout_2000');}, 2000);
setTimeout(() => { // далее - асинхронную функцию с задержкой в 4000 миллисекунд
...
// 	alert('Done!');
// }
// count(); // подобный код может на долго повесить страницу, поэтому рекомендуется все расчеты разбивать на этапы, с последовательным движение от одного к другому!!!
