...
const shortNames = names.filter(function(name) { // стрелочная функция работает также, name -каждоеотфильтрованное имя массива
