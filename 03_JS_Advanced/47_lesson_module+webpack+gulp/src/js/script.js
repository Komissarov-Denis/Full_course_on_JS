...
// поименованный синтаксис

// import {one, two} from './modules/hello.js'; // фигурные скобки {} для поименованного синтаксиса обязательны, так как экспортируется большой объект
