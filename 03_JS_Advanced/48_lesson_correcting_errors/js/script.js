...
} finally { // работает также как и в промиссах, код в этой части выполнится всегда, задача завершить начатые операции при любом ходе событий
...
// получил:
// Normal..., главный плюс, в том - что код, написанный после консрукции, не поломается и продолжит работать
// Error!!!
// ReferenceError
// undefined
