...
console.log(4 + +'5'); // унарный плюс без пробелаперед строкой - это перевод строки в число!!! получил: 9

// Операторы,-ИНКРЕМЕНТ-и-ДЕКРИМЕНТ,-И-и-ИЛИ-----------------
let incr = 10;
let decr = 10;
...
console.log(2 * 4 == '8'); // сравнение, получил: true, так как стравниваем по значению, а не типу данных!!!
console.log(2 * 4 === 7); // строгое равенство, получил: false
console.log(2 * 4 === '8'); // строгое равенство, получил: false, так как стравниваем по типу данных, а не значению!!!

// && - оператор И => ЗАПИНАЕТСЯ НА FALSE!!!
// || - оператор ИЛИ => ЗАПИНАЕТСЯ НА TRUE!!!
const isCheked = true;
const isClosed = false;
console.log(isCheked && isClosed); // получил: false, оператор && возвращает правду, если все выражения true, а если хоть один false, то и вернет false!!!
console.log(isCheked || isClosed); // получил: true, оператор || возвращает правду, если хотя бы один оператор true, а если оба false, то и вернет false!!!
console.log(isCheked && !isClosed); // получил: true, ! - заменяет на обратное значение аргумента, тут все правда
...
// В соответствии с динамической типизацией, 5 сущностей будут false: нуль, пустая строка, null, udefined, NaN. Все остальное всегда true!!!
