...
console.log(typeof([ ] + false)); // получил: string, т.е. строковый тип данных, так как конкатенируя строку с другим типом данных - получаем строку или 'false' !!!

console.log('' + false); // получил: false
console.log(typeof('' + false)); // получил: string

console.log('false' - null); // получил: NaN
console.log(typeof('false' - null)); // получил: number, так как тут минус!!! Строка минус число, будет число. Если бы был +, то конкатенация создала бы строку!!!
...
console.log('Ёжик' > 'яблоко'); // Ответ: false, в Юникод можно посмотреть приоритет символов, так как unicode посимвольно сравнивает, смотрим таблицу сравнения 

// 12) Чему равно 0 || "" || 2 || undefined || true || false ?
console.log(0 || '' || 2 || undefined || true || 'false'); // Ответ: 2
