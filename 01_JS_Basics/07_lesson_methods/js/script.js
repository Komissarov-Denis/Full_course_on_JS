...
console.log(fruit.indexOf('q')); // -1 означает отсутствие подобных букв в словах строки
...
console.log(logg.slice(-6, -1)); // инверсия вырезаемых символов ;-) с 6 справа до 1 справа
