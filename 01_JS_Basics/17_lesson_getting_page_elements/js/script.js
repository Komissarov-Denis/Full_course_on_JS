...
const link = document.querySelector('a'); // по тегу точку не ставим, в отличие от класса!!!
// ЕСЛИ ИЩЕМ ПО КЛАССУ, ТО СТАВИМ "." // ЕСЛИ ИЩЕМ ПО ID ТО СТАВИМ # // А ЕСЛИ ПО БЛОКУ DIV или <ТЕГу>, ТО СТАВИТЬ ЧТО-ТО НЕ НУЖНО // ЕСТЬ ЕЩЕ DATA-ATTRIBUTE!!!