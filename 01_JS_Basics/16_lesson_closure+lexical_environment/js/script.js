...
// на 3 шаге number = 6 (5 меняется на 6, переход к вызыву logNumber())
...
// на 10 шаге number = 10 (переход к вызыву logNumber())
...
// } debugger; // при этом внутреннее лексическое окружение myFunction будет уничтожено по выполнению return!!! Но, наружу возвращаем описание действий вложенного функционального выражения myFunction - это ее ЗАМЫКАНИЕ!!!
