...
// на 8 шаге переходим в переменную increment с вызовом присвоенной ей функцией createCounter(), получаем значения:
	// c1:<значение недоступно>
	// c2:<значение недоступно>
	// c3:<значение недоступно>
	// increment: ƒ ()
...
// на 9 шаге переходим в переменную с1, получаем значения:
	// c1:<значение недоступно>
	// c2:<значение недоступно>
	// c3:<значение недоступно>
	// increment: ƒ ()
...
// на 12 шаге переходим в return counter, получаем значения:
	// myFunction() undefined
	// c1:<значение недоступно>
	// c2:<значение недоступно>
	// c3:<значение недоступно>
...
// на 13 шаге возвращаем расчитанное значение counter, получаем значения:
	// myFunction() undefined
	// Вернуть значение: 1
	// Закрытие (createCounter) удаляется локальное лексическое окружение myFunction()
		// counter: 1
	// c1:<значение недоступно>
	// c2:<значение недоступно>
	// c3:<значение недоступно>
...
// на 14 шаге переходим в переменную с1, получаем значения:
	// c1: 1
	// c2:<значение недоступно>
	// c3:<значение недоступно>
	// increment: ƒ ()
...
//  на 15 шаге переходим в переменную с2, получаем значения:
	// c1: 1
	// c2:<значение недоступно>
	// c3:<значение недоступно>
	// increment: ƒ ()
...
// на 16 шаге переходим в функцию myFunction(), создается локальное лексическое окружение, получаем значения:
	// myFunction() undefined
	// Закрытие (createCounter) удаляется локальное лексическое окружение myFunction()
		// counter: 1
	// c1: 1
...
// на 17 шаге переходим в счетчик переменной counter = counter + 1, получаем значения:
	// myFunction() undefined
	// Закрытие (createCounter) удаляется локальное лексическое окружение myFunction()
		// counter: 1
	// c1: 1
...
// на 18 шаге переходим в return counter, получаем значения:
	// myFunction() undefined
	// Закрытие (createCounter) удаляется локальное лексическое окружение myFunction()
		// counter: 2
	// c1: 1
...
// на 19 шаге возвращаем расчитанное значение counter, получаем значения:
	// myFunction() undefined
	// Вернуть значение: 2
	// Закрытие (createCounter) удаляется локальное лексическое окружение myFunction()
		// counter: 2
...
// на 20 шаге переходим в переменную с2, получаем значения:
	// c1: 1
	// c2: 2
	// c3:<значение недоступно>
	// increment: ƒ ()
...
// на 21 шаге переходим в переменную с3, получаем значения:
	// c1: 1
	// c2: 2
	// c3:<значение недоступно>
	// increment: ƒ ()
...
// на 22 шаге  переходим в функцию myFunction(), создается локальное лексическое окружение, получаем значения:
	// myFunction() undefined
	// Закрытие (createCounter) удаляется локальное лексическое окружение myFunction()
		// counter: 2
	// c1: 1
...
// на 23 шаге  переходим в счетчик переменной counter = counter + 1, получаем значения:
	// myFunction() undefined
	// Закрытие (createCounter) удаляется локальное лексическое окружение myFunction()
		// counter: 2
	// c1: 1
...
// на 24 шаге переходим в расчитываем counter, получаем значения:
	// myFunction() undefined
	// Закрытие (createCounter) удаляется локальное лексическое окружение myFunction()
		// counter: 3
	// c1: 1
...
// на 25 шаге переходим в return counter, получаем значения:
	// myFunction() undefined
	// Закрытие (createCounter) удаляется локальное лексическое окружение myFunction()
		// counter: 3
	// c1: 1
...
// на 26 шаге возвращаем расчитанное значение counter, получаем значения:
	// myFunction() undefined
	// Вернуть значение: 3
	// Закрытие (createCounter) удаляется локальное лексическое окружение myFunction()
		// counter: 3
...
// на 27 шаге переходим в переменную с3, получаем значения:
	// c1: 1
	// c2: 2
	// c3: 3
	// increment: ƒ ()
...
// на 28 шаге переходим в console.log(c1, c2, c3), возвращаем значения:
	// c1: 1
	// c2: 2
	// c3: 3
	// increment: ƒ ()
...
// на 29 шаге вывели в консоль: 1 2 3