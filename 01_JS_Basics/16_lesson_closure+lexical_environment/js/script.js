...
// на 6 шаге console.log(number) = 4 (возвращается в консоль ссылка на рассчитанное значение 4)
...
// на 13 шаге console.log(number) = 4 (возвращается в консоль ссылка на рассчитанное значение 4)
...
for (let i = 0; i < 9; i++) {
	...
	console.log(num); // почему тут мы не можем обратиться к переменной num (код выдаст ошибку), область видимости num - это цикл 'j'!!! ВНУТРЕННЕЕ ЛЕКСИЧЕСКОЕ ОКРУЖЕНИЕ ВНУТРИ {}, внутри ЦИКЛА!!!
}
//-----------------------------------------------------------------------------------------------------------------------
...
const increment = createCounter(); debugger; // помещаем в переменную increment со значением undefined функциональное выражение createCounter() с ее вызовом и возвращением функционального выражения myFunction
...
// на 7 шаге переходим в return myFunction, возвращаем рассчитанное значение функции myFunction(), получаем значения:
	// createCounter() undefined
