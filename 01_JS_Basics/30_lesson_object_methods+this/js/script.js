...
btn2.addEventListener('click', () => {
	console.log(this); // получаем: window - как некорректное поведение, так как у стрелочной функции нет своего контекста вызова, она будет брать его у своего родителя!!!
...
console.log(double2(4));  // получаем: 8, но гораздо короче и оптимальнее можно записать в одну строчку //=>=>=>=>=>=>
//=>=>=>=>=>=>
const double3 = a => a * 2; // если действие функции помещается в одну строчку, то ее можно записать вот подобным образом без боковых скобок, если аргумент один и без ключевого слова return!!!
console.log(double3(4)); // получаем: 8

const double4 = (a, b) => a * 2 + b; // если действие функции помещается в одну строчку, то ее можно записать вот подобным образом!!!
console.log(double4(4, 5)); // получаем: 13