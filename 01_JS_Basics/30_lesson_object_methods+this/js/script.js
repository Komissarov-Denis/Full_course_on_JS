...
} // в строгом режиме получаем: undefined
...
function showThis2(a, b) {
	...
	function sum() {
		console.log(this); // получаем: undefined
		// return this.a + this.b; // получаем: Window и NaN некорректное поведение, ДАННЫЙ ПРИЕМ НЕ РАБОТАЕТ, данная функция не видит значение THIS!!!
...
console.log(double(3)); // получаем: 6, теперь в фикцию double мы можем передавать только один аргумент (3) и (13), который будет всегда удваиваться!!!
