...
// МЕТОД forEach(function(){}) - это метод с коллбэк функцией внутри, сначала выполняется forEach(), а потом уже function(), ТУТ ОПЕРАТОРЫ BREAK и CONTINUE не работают!!!
...
arr2.pop(); // метод, удаляющий последний элемент из нашего массива: 8
