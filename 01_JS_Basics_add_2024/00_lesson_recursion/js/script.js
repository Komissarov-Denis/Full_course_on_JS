...
console.log(pow3(2, 2)); // => функция pow3(2, 2) проходит все строки условия, при невыполнении переходит в else{}, =>
// => запускает расчет pow3(2, 2 - 1) с аргументами 2 и со степенью 1, проходит все строки условия, условие (n === 0) не выполнилось, условие (n === 1) выполнилось, функция возвращается в else{return x * pow3(x, n - 1);},
// => последовательно возвращает х => 2 => 4, последнее значение 4 выводится в консоль, получил: 4
console.log(pow3(2, 3)); // => функция pow3(2, 3) проходит все строки условия, при невыполнении переходит в else{}, =>
// => запускает расчет pow3(2, 3 - 1) с аргументами 2 и со степенью 2, проходит все строки условия, при невыполнении переходит в else{}, 
// => запускает расчет pow3(2, 2 - 1) с аргументами 2 и со степенью 1, проходит все строки условия, условие (n === 0) не выполнилось, условие (n === 1) выполнилось, функция возвращается в else{return x * pow3(x, n - 1);},
// => последовательно возвращает х => 2 => 4 => 8, последнее значение 8 выводится в консоль, получил: 8
console.log(pow3(2, 4)); // => функция pow3(2, 4) проходит все строки условия, при невыполнении переходит в else{}, =>
// => запускает расчет pow3(2, 4 - 1) с аргументами 2 и со степенью 3, проходит все строки условия, при невыполнении переходит в else{},
// => запускает расчет pow3(2, 3 - 1) с аргументами 2 и со степенью 2, проходит все строки условия, при невыполнении переходит в else{}, 
// => запускает расчет pow3(2, 2 - 1) с аргументами 2 и со степенью 1, проходит все строки условия, условие (n === 0) не выполнилось, условие (n === 1) выполнилось, функция возвращается в else{return x * pow3(x, n - 1);},
// => последовательно возвращает х => 2 => 4 => 8 => 16, последнее значение 16 выводится в консоль, получил: 16
// получил: 1 2 4 8 16, РЕШЕНО!!!
