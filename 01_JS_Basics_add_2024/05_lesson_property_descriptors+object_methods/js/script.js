...
// МЕТОД Object.preventExtensions() - предотвращает любое расширение объекта, т.е. после его создания никакие ключевые свойства не добавляются
...
// МЕТОД Object.freeze() - замораживает объект - объект становится эффективно неизменным в принципе , ничего не удаляется, не добавляется и не изменяется
Object.freeze();
...
// МЕТОД Object.is() - позволяет сравнивать объекты на предмет различий
Object.is();

// МЕТОД Object.keys() - возвращает массив из собственных перечисляемых ключевых свойств переданного объекта, в том же порядке, в котором они бы обходились циклом for(...in...)
Object.keys();

// МЕТОД Object.is() - возвращает массив из собственных перечисляемых свойств ключевых значений переданного объекта, в том же порядке, в котором они бы обходились циклом for(...in...)
Object.values();

// МЕТОД Object.is() - возвращает массив из собственных перечисляемых ключевых свойств переданного объекта в формате [key, value], в том же порядке, в котором они бы обходились циклом for(...in...)
Object.entries();