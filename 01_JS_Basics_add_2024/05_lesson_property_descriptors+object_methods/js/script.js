...
// МЕТОД Object.keys() - возвращает массив из собственных перечисляемых ключевых свойств переданного объекта, в том же порядке, в которм они бы обходились йиклом for(...in...)
Object.keys();

// МЕТОД Object.is() - возвращает массив из собственных перечисляемых свойств ключевых значений переданного объекта, в том же порядке, в которм они бы обходились йиклом for(...in...)
Object.values();

// МЕТОД Object.is() - возвращает массив из собственных перечисляемых ключевых свойств переданного объекта в формате [key, value], в том же порядке, в которм они бы обходились йиклом for(...in...)
Object.entries();