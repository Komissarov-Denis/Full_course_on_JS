...
const sayHello = outer(); // переменная записывает в себя данные расчетов функции inner(), в sayHello через замыкание находится ссылка на potentiallyHugeArray[], который все время будет находиться в памяти, что приведет к её утечке!!!
