...
// 4. setState() и вообще изменение State - это асинхронная операция, если нам нужна точность или последовательность данных (зависящих от предыдущего состояния), то мы должны передавать коллбэк функцию;
